...
/**
 * Model of all input sets of a problem
 * 
 * @author jfaryad
 * 
 */
public class AllInputSetsByProblem extends LoadableDetachableModel<List<InputSet>> {
    ...
    public AllInputSetsByProblem(IModel<ProblemType> problem) {
