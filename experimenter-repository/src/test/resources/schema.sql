...
CREATE TABLE USER_USERGROUP (
  user_usergroup_id INTEGER NOT NULL IDENTITY,
...
CREATE TABLE EXPERIMENT_INPUT_SET (
  experiment_input_set_id INTEGER NOT NULL IDENTITY,
...
CREATE TABLE PROJECT_INPUT_SET (
  project_input_id INTEGER NOT NULL IDENTITY,
  input_set_id INTEGER NOT NULL,
  project_id INTEGER NOT NULL,
);
...
CREATE TABLE INPUT_INPUT_SET (
  input_input_set_id INTEGER NOT NULL IDENTITY,
...
CREATE TABLE EXPERIMENT_FARM (
  experiment_farm_id INTEGER NOT NULL IDENTITY,
  experiment_id INTEGER NOT NULL,
  farm_id INTEGER NOT NULL,
);
