...
CREATE SEQUENCE SEQ_USER AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_USERGROUP AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_COMPUTER AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_CONNECTION AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_EXPERIMENT AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_PROJECT AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_INPUT AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_INPUT_SET AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_APPLICATION AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_PROGRAM AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_PROBLEM AS INTEGER START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SEQ_FARM AS INTEGER START WITH 1 INCREMENT BY 1;
...
ALTER TABLE EXPERIMENT ADD FOREIGN KEY (experiment_id) REFERENCES PROJECT (project_id);
